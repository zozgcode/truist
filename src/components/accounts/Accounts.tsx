        ...
        <div className="w-full">
          <div className="p-5 pb-10 bg-[#2d1a47]">
            <header className="py-4 mb-6 text-white flex items-center justify-center w-full p-5">
              ...
              <div className="flex items-end justify-end w-[45%]">
                <FaRegCircleUser className="text-[32px]" />
              </div>
          ...
          <div className="border p-5">
            ...
            <div className="w-full bg-white rounded-lg h-full p-5">
              <div className="flex justify-between">
                <span className="block text-black text-[24px] font-semibold mb-1">
                  Checking Account
                </span>
                <span className="block text-black font-semibold text-[24px] mb-1">
                  {user.checkingAccountNo}
                </span>
              </div>
              <p className="flex justify-between mt-4 text-[26px] items-center font-bold text-gray-800">
                <span className="font-normal text-[24px]">Available Balance</span>
          ...
          <div className="p-5 px-2">
            <div className="bg-white flex items-center justify-between rounded p-3 py-2 text-[24px] w-full">
